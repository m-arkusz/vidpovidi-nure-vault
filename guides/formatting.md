...
## Назва файлу
Назва файлу має складатись з малих латинських літер `[a-z]`, номерів `[0-9]` та символів: `-`, `_`.
Дисципліна, номер тесту та літера семестру (латинська о/v) транслітеруються.

Приклад: `fvs-4_5-o25` --- ФВС, тест 4-5, осінній семестр 2025 року.
...
Коротке посилання (permalink):
- 6 випадково згенерованих символів з нижнього регістру та цифр (`[a-z][0-9]`)
	Використовується для скороченого посилання: `https://ans.linerds.us/s/voko71`
## Дані
